...
process error. FYI the code for this model lives in R/functions.R.
...
SOM is then lost via heterotrophic respiration, which is assumed to be proportional to the size of the SOM pool and to follow a standard Q10 temperature 
sensitivity. Finally, Normal process error is added to all columns in X to account for model inadequacy. 
